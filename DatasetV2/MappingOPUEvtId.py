...
def file2arr(filestub):
        ...
        namedir = '/homeijclab/struillou/Stage M1 Victor Struillou/SortieTASF/fmixed_data_'
...
outdir = "/homeijclab/struillou/Stage M1 Victor Struillou/SortieOPU/"
print("Output directory:", outdir)
    
ncomp=200000 #number of random features produced
typ='ttbar' #Process type ttbar or W
    
quartile_filter = pd.read_csv('/homeijclab/struillou/Stage M1 Victor Struillou/quartiles/quartile_filters_'+typ+'.csv',
                                    index_col=0)
...
with random_mapping.opu:
    for i, filestubn in enumerate(tqdm(range((len(os.listdir('/homeijclab/struillou/Stage M1 Victor Struillou/SortieTASF')))//13))):
