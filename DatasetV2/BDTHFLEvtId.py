...
def creation_megadatasets(chemin,limit):
    ...
    scoresOPU=pd.read_csv('C:/Users/vicru/Desktop/StageRousseauM1/PythonML/Megatestnewbase/ScoresAvecEvtID/ScoresOPU.csv')
...
datasetHLF,datasetHLF_new,labels_signaux_ttbar,labels_signaux_W,weights = creation_megadatasets('C:/Users/vicru/Desktop/StageRousseauM1/PythonML/Megatestnewbase/Melange',100000)
...
print(accuracytest_ttbar)
print(accuracytrain_ttbar)

print(accuracytest_W)
print(accuracytrain_W)
...
ax=hLF[labels_signaux_ttbar==0].hist(weights=weights[labels_signaux_ttbar==0],figsize=(15,12),color='b',alpha=0.5,density=True,label="B")
ax=ax.flatten()[:hLF.shape[1]] # to avoid error if holes in the grid of plots (like if 7 or 8 features)
hLF[labels_signaux_ttbar==1].hist(weights=weights[labels_signaux_ttbar==1],figsize=(15,12),color='r',alpha=0.5,density=True,ax=ax,label="S")
...
ax=hLF[labels_signaux_W==0].hist(weights=weights[labels_signaux_W==0],figsize=(15,12),color='b',alpha=0.5,density=True,label="B")
ax=ax.flatten()[:hLF.shape[1]] # to avoid error if holes in the grid of plots (like if 7 or 8 features)
hLF[labels_signaux_W==1].hist(weights=weights[labels_signaux_W==1],figsize=(15,12),color='r',alpha=0.5,density=True,ax=ax,label="S")
...
plt.title("Feature importances ttbar")
plt.show()
...
plt.xticks(rotation=90)
plt.title("Feature importances W")
plt.show()
...
print(accuracytest_ttbar_dp)
print(accuracytrain_ttbar_dp)

print(accuracytest_W_dp)
print(accuracytrain_W_dp)
...
ax=hLF2[labels_signaux_ttbar==0].hist(weights=weights[labels_signaux_ttbar==0],figsize=(15,12),color='b',alpha=0.5,density=True,label="B")
ax=ax.flatten()[:hLF2.shape[1]] # to avoid error if holes in the grid of plots (like if 7 or 8 features)
hLF2[labels_signaux_ttbar==1].hist(weights=weights[labels_signaux_ttbar==1],figsize=(15,12),color='r',alpha=0.5,density=True,ax=ax,label="S")
...
plt.xticks(rotation=90)
plt.title("Feature importances ttbar avec deltaphi")
plt.show()
...
plt.xticks(rotation=90)
plt.title("Feature importances W avec deltaphi")
plt.show()
...
print(accuracytest_ttbar_dp_new)
print(accuracytrain_ttbar_dp_new)
...
plt.xticks(rotation=90)
plt.title("Feature importances ttbar avec deltaphi et scores OPU")
plt.show()
