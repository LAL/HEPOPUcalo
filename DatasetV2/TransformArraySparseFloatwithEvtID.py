# This code converts mixed .h5 from DatamixerwithEvtID.py into arrays.
# Contrary to TransformArraySparseFloat, it takes into account the EventIDs.
...
def convert_sample(inFileName, limit=False):
    ...
    outFileName = 'C:/Users/vicru/Desktop/StageRousseauM1/PythonML/Megatestnewbase/SortieTASF/' + 'f' + inFileName
    
    f = h5py.File("C:/Users/vicru/Desktop/StageRousseauM1/PythonML/Megatestnewbase/Melange/" + inFileName, "r")
    ...
    np.savez(outFileName + "EventID.npz", data = tmp2, dtype = np.int32)
    
    
#Example of usage below:        
fichiers_mixes=os.listdir("C:/Users/vicru/Desktop/StageRousseauM1/PythonML/Megatestnewbase/Melange")
